...
const events_1 = window.require("events");
const child_process_1 = window.require("child_process");
const os_1 = window.require("os");
const path_1 = window.require("path");
const fs_1 = window.require("fs");
const util_1 = window.require("util");
